...
export class AuthController {
  ...
  async login(@Request() req) {
    return this.authService.login(req.user, req.headers['user-agent'], req.headers['host']);
  }
  ...
  async refreshToken(@Request() req): Promise<any> {
    return this.authService.refreshToken(req.sessionId, req.user, req.headers['user-agent'], req.headers['host']);
  }
